...
const SignupForm = ({ onSwitchToLogin, onClose }) => {
  ...
  return (
    <div className="relative z-50 w-[400px] max-w-md p-7 rounded-md bg-gradient-to-br from-[#141414] to-[#111111] text-white">
      ...
      <form onSubmit={handleOnSubmit} className="flex flex-col gap-y-6">
        ...
        <p className="text-center text-sm text-white-400 mt-4">
